...
class _SearchState extends State<Search> {
  ...
  handleSearch(String str){
    ...
    Future.delayed(Duration(milliseconds: 300)).then((_){
      Future<QuerySnapshot> users = usersRef.where('displayName', isGreaterThanOrEqualTo: _controller.text).getDocuments();
      setState(() {
    ...
    return AppBar(
      ...
      title: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          //  filled: true,
            prefix: Icon(Icons.account_box, size: 28.0, color: Theme
                .of(context)
                .primaryColor,),
            suffix: IconButton(
